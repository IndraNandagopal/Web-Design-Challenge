...
In this project, HTML and CSS were used to create create a website by using visualizations that were created in your Python-APIs, as captured in the following image:

  ![Images/Landing_page.PNG](assets/images/Landing_page.PNG)

## Initial Instructions

1. Created a new repository for this project called `Web-Design-Challenge`. 

2. Cloned the new repository to my computer.

3. Inside the local Git repository, added the HTML files along with three folders; `assets`, `Resources` and `visualizations`. 

  * Included an `index.html` file in the main folder. It is the landing page that a user first encounters when viewing this submission.

  * Inside the `assets` folder, created two more folders: `css` and `images`, which are used to store the CSS and image assets, respectively.

  * The `Resources` folder contains the CSV file with the data for this website. The `visualizations` folder contains the HTML pages that display the visualizations.

4. Pushed the changes from Steps 1 through 3 to GitHub.
